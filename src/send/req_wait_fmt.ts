import { OracleFetchOptions, OracleContractResponse, FormattedOracleRequest } from "../types";
import { createRequest } from "../create";
import { checkResult } from "../check";
import { formatResponse } from "../format";
import { submitRequest } from "../submit";

export default async function sendRequestAndWaitFormatted(request: FormattedOracleRequest, opts: OracleFetchOptions) : Promise<OracleContractResponse> {
